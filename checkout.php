...
<body>
    ...
    <div class="container">
    <h3>Checkout Form: <?php echo "$" . $_REQUEST['price'];?> </h3>
      <form action="action_page.php" method="post">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="fname" name="full_name" placeholder="John Smith">
            <label for="email"><i class="fa fa-envelope"></i> Email</label>
            <input type="text" id="email" name="email" placeholder="john@example.com">
            <label for="address"><i class="fa fa-address-card-o"></i> Address</label>
            <input type="text" id="adr" name="address" placeholder="42 High Street">
            <label for="city"><i class="fa fa-institution"></i> City</label>
            <input type="text" id="city" name="city" placeholder="Wellington">
            <label for="zip">Zip</label>
            <input type="text" id="zip" name="zip" placeholder="6023">
              </div>
            </div>
          </div>
          ...
          <div class="payment">
            ...
            <label for="creadit_card">Credit card number</label>
            <input type="text" id="ccnum" name="credit_card" placeholder="1111-2222-3333-4444">
